        ...
        <div class="grandio-content-column">
            ...
            <div class="grandio-product-summary">
                ...
                <?php if ($product->get_rating_count()) : ?>
                    <div class="grandio-product-rating">
...
if (!empty($cross_sell_ids)) :
    foreach ($cross_sell_ids as $cross_sell_id) :
        ...
        $tags = wp_get_post_terms($cross_sell_id, 'product_tag', array('fields' => 'names'));
        $categories = wp_get_post_terms($cross_sell_id, 'product_cat', array('fields' => 'names'));
        
        $is_anchor = false;
        $is_essential = false;
        
        foreach (array_merge($tags, $categories) as $term) {
            if (stripos($term, 'anchor') !== false || stripos($term, 'installation') !== false) {
                $is_anchor = true;
                break;
            }
            if (stripos($term, 'essential') !== false || stripos($term, 'required') !== false) {
                $is_essential = true;
                break;
            }
        }
...
function render_compact_product_card($cross_product) {
    ...
    <div class="compact-product-card <?php echo $is_variable ? 'variable-product' : ''; ?>" 
        ...
        <div class="compact-card-main">
            ...
            <!-- Expand Button -->
            <?php if ($cross_product->get_short_description() || $is_variable) : ?>
        ...
        <div class="compact-description" style="display: none;">
            <div class="compact-description-content">
                ...
                <?php if ($cross_product->get_short_description()) : ?>
                    <div class="product-description-text">
                        <?php echo wpautop($cross_product->get_short_description()); ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<div class="package-section essential-section">
    <h3 class="package-section-title">
        ...
        <span class="section-badge essential-badge">Anchoring Systems</span>
    </h3>
